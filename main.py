import argparse
from words_in_proteome import read_sequences, search_word_in_proteome, find_most_frequent_word, read_words
from genbank2fasta import read_file, extract_organism
